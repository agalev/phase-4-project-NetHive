      ...
      <div className="flex flex-col h-full bg-gray-100">
        <div className="flex-1 overflow-y-scroll px-4 py-2">
          <div className="flex flex-wrap justify-center items-start">
            ...
            <div onClick={(e) => handleRoomJoin(e.target.id, dispatch)} className="rounded-full p-2 m-1 bg-yellow-600 text-red-100 w-24 h-24 flex items-center justify-center text-xl font-bold animate-upanddown cursor-pointer" id={rooms[17].id}>#{rooms[17].topic}</div>
            ...
            <div onClick={(e) => handleRoomJoin(e.target.id, dispatch)} className="rounded-full p-2 m-1 bg-pink-600 text-red-100 w-24 h-24 flex items-center justify-center text-xl font-bold animate-upanddown3 cursor-pointer" id={rooms[29].id}>#{rooms[29].topic}</div>
            ...
            <div onClick={(e) => handleRoomJoin(e.target.id, dispatch)} className="rounded-full p-2 m-1 bg-blue-600 text-red-100 w-32 h-32 flex items-center justify-center text-xl font-bold animate-upanddown2 cursor-pointer" id={rooms[32].id}>#{rooms[32].topic}</div>
            ...
            <div onClick={(e) => handleRoomJoin(e.target.id, dispatch)} className="rounded-full p-2 m-1 bg-blue-600 text-red-100 w-24 h-24 flex items-center justify-center text-xl font-bold animate-upanddown2 cursor-pointer" id={rooms[40].id}>#{rooms[40].topic}</div>
